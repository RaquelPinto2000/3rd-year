...
typedef struct
{
   ...
   pthread_mutex_t accessCR; //variavel de acesso
   pthread_cond_t fifoNotFull; // variavel para ver se o fifo nao esta cheio
   pthread_cond_t fifoNotEmpty; // variavel para ver se o fifo nao e vazia
