...
class Accident(db.Model):
    ...
    congested = db.Column(db.Integer, nullable=False, default=0)
    ambulance = db.Column(db.Integer, nullable=False, default=0)
...
class Camera(db.Model):
    ...
    linkRTSP = db.Column(db.String, nullable=False)

    def __init__(self,id,latitude,longitude,linkRTSP):
        self.id = id
        self.latitude = latitude
        self.longitude = longitude
        self.linkRTSP = linkRTSP

class Ambulance(db.Model):
    id_ambulance = db.Column(db.Integer, primary_key=True)
    id_user = db.Column(db.Integer)

    def __init__(self,id_ambulance,id_user):
        self.id_ambulance = id_ambulance
